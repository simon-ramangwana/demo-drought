...
RUN_ID = f"train_tws_proxy_model_{RUN_TS}"

DATASET_PATH = DATASETS_DIR / "cmip6_tws_proxy_training_dataset_20260322T134524Z.parquet"

MODEL_PATH = MODELS_DIR / f"tws_proxy_model_{RUN_TS}.joblib"
...
valid_df = df[(df["_yyyymm_int"] >= 202101) & (df["_yyyymm_int"] <= 202409)].copy()
