...
RUN_ID = f"train_cmip6_bias_model_d2m_{RUN_TS}"

DATASET_PATH = DATASETS_DIR / "cmip6_d2m_training_dataset_20260321T115849Z.parquet"

MODEL_PATH = MODELS_DIR / f"cmip6_bias_model_d2m_{RUN_TS}.joblib"
...
# ---------------------------------------------------------------------
print("=" * 60)
print("TRAIN CMIP6 D2M BIAS MODEL")
print("=" * 60)
...
print(f"Valid MAE     : {metrics['valid_mae']:.4f}")
print(f"Valid RMSE    : {metrics['valid_rmse']:.4f}")
